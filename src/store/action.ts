...
export function addToCardAction(
  payload: ProductCardType
): ActionMapTypes["ADD_TO_CART"] {
  return {
    type: ADD_TO_CART,
    payload,
  };
...
export function removeFromCartAction(
  payload: ProductCardType
): ActionMapTypes["REMOVE_FROM_CART"] {
  return {
...
export function loadCatalogAction(
  payload: Array<ProductCardType>
): ActionMapTypes["LOAD_CATALOG"] {
  return {
    type: LOAD_CATALOG,
    payload,
  };
...
export function openSignInModalAction(
  payload: boolean
): ActionMapTypes["OPEN_SIGN_IN_MODAL"] {
  return {
...
export function openSignUpModalAction(
  payload: boolean
): ActionMapTypes["OPEN_SIGN_UP_MODAL"] {
  return {
